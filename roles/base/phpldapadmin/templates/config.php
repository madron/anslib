...
$servers->setValue('server','name','{{ phpldapadmin_ldap_description }}');
...
$servers->setValue('server','base',array('{{ phpldapadmin_ldap_base }}'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
// $servers->setValue('login','bind_id','dn="{{ phpldapadmin_ldap_bind }}"');
